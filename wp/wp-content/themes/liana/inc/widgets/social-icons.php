...
class liana_social_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'liana_social_button', // Base ID
			__( 'liana Social Icons', 'liana' ), // Name
			array( 'description' => __( 'Displaying social icons', 'liana' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title :', 'liana' );
				?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Enter facebook URL:', 'liana' );
				?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Enter twitter URL:', 'liana' ); ?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'google' ) ); ?>"><?php esc_html_e( 'Enter google URL:', 'liana' ); ?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'pinterest' ) ); ?>"><?php esc_html_e( 'Enter pinterest URL:', 'liana' ); ?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Enter dribbble URL:', 'liana' ); ?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'Enter behance URL:', 'liana' ); ?></label>
		...
		<p>
			<label
				for="<?php echo esc_attr( $this->get_field_id( 'youtube' ) ); ?>"><?php esc_html_e( 'Enter youtube URL:', 'liana' ); ?></label>
	...
	public function widget( $args, $instance ) {
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Social Icons', 'liana' ) :
...
// register widgets
if ( ! function_exists( 'liana_social_icon_register' ) ) {
	function liana_social_icon_register() {
		register_widget( 'liana_social_Widget' );
	}

	add_action( 'widgets_init', 'liana_social_icon_register' );
}
